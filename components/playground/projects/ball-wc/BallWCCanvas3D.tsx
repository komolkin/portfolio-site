...
import type { BallPhysicsRefs } from "@/components/playground/projects/ball-wc/ball-wc-physics";

const SOCCER_TEXTURE = "/playground/ball-wc/color-transition-texture.png";
...
type BallWCCanvas3DProps = {
  physics: BallPhysicsRefs;
  width: number;
  height: number;
};

export default function BallWCCanvas3D({ physics, width, height }: BallWCCanvas3DProps) {
