  ...
  return (
    <div className="flex h-full w-full items-center justify-center p-4">
      ...
      <button
        ...
        className="absolute top-4 right-4 z-[2] flex size-10 shrink-0 items-center justify-center rounded-full border border-white/10 text-white transition-[border-color,background-color] duration-150 ease-out hover:border-white/15 hover:bg-white/[0.06] active:scale-[0.95]"
      >
        <SwitchSidesIcon
      ...
      <div className="flex w-full items-center gap-4 pr-12">
