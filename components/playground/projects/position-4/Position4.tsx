 ...
 */
const IMG_THUMB = "/playground/position-4/england-flag.svg";
      ...
      <div className="flex w-full flex-col gap-4">
        ...
        >
          {cashOutGlow.mode !== "off" && (
            <span
              aria-hidden
              className="position4-cash-out-glow pointer-events-none absolute inset-0 rounded-full motion-reduce:opacity-60"
              style={{
