 ...
 * OKC thumbnail — 5261:23953 → public/playground/position-1/thumbnail.png
 */
const IMG_THUMB = "/playground/position-1/thumbnail.png";
...
export default function Position1() {
  ...
  return (
    <div
      ...
      aria-controls="position-1-expanded"
    ...
    >
      ...
      <div
        ...
        aria-controls={expanded ? "position-1-expanded" : undefined}
