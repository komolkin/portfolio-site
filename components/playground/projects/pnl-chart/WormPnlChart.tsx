...
import { PNL_GLASS_INSET, PNL_GLASS_OVERLAY } from "@/components/playground/projects/pnl-chart/pnlGlass";
...
export default function WormPnlChart({
  ...
  return (
    ...
    >
      <div
        className={`pointer-events-none absolute inset-0 z-20 flex items-center justify-center rounded-3xl ${PNL_GLASS_OVERLAY} transition-opacity duration-400 ease-out ${
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="relative inline-flex items-center rounded-full bg-white/[0.05] p-1 backdrop-blur-sm">
          <span
